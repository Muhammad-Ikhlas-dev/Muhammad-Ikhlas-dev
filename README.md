...
2. **Advanced Authentication & User Management System**  
   Built a secure authentication system supporting Google OAuth and manual login. Implemented REST APIs with Node.js and stored encrypted user data (passwords, tokens, etc.) in MongoDB.  
   *Tech Stack:* Node.js • Express • MongoDB • JWT

3. **AI Model Fine-Tuning for Production-Ready Code**  
